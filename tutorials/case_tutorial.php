...
if(common::$sql['default']->rowCount()) {
    ...
    $showmore = $smarty->fetch('file:['.common::$tmpdir.']'.$dir.'/comments/comments.tpl');
    $smarty->clearAllAssign(); unset($comments);

    $smarty->caching = false;
    $smarty->assign('head',_tutorials." - ".$get['name']);
    ...
    $smarty->assign('v_bewertung',tutorials::get_html_user_rating($get['id']));
