...
<head>
    ...
    <script type="text/javascript" src="{dir}/_js/fileman/custom.js"></script>
    <script type="text/javascript" src="{dir}/_js/fileman/main.js"></script>
    <script type="text/javascript" src="{dir}/_js/fileman/utils.js"></script>
    <script type="text/javascript" src="{dir}/_js/fileman/file.js"></script>
    <script type="text/javascript" src="{dir}/_js/fileman/directory.js"></script>
    <script type="text/javascript" src="{dir}/_js/jquery-dateFormat.min.js"></script>
</head>
<body>
