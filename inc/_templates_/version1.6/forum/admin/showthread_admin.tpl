  ...
  <tr>
    <td>
      ...
      <table class="hperc" cellspacing="1">
        <tr>
          <td class="contentHead" colspan="3" align="center"><span class="fontBold">{lang msgID="admin"}</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="contentMainTop">
            <select name="move" class="dropdown">
              <option value="lazy">{lang msgID="forum_admin_moveto"}</option>
              {$move}
            </select>
          </td>
