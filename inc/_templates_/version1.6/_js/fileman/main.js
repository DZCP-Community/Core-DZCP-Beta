...
function dragFileOver() {
    $(this).children('img.dir').attr('src', 'images/fileman/folder-green.png');
}

function dragFileOut() {
    $('#pnlDirList').find('img.dir').attr('src', 'images/fileman/folder.png');
}
...
function makeDragDir(e) {
    ...
    return '<div class="pnlDragDir" data-path="' + f.fullPath + '"><img src="images/fileman/folder.png" align="absmiddle">&nbsp;' + f.name + '</div>';
}
...
function switchView(t) {
    ...
    if (t == 'thumb') {
        $('#pnlFileList .icon').attr('src', 'images/fileman/blank.gif');
