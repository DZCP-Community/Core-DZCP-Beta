...
$language_text['_zitaticon'] = '../inc/lang/images/de/quote.png';
$language_text['_pn_write_forum'] = '<a href="../user/?action=msg&amp;do=pn&amp;id={$id}"><img src="../inc/lang/images/de/pn.png" alt="" title="{$nick} eine Nachricht schreiben" class="icon" /></a>';
$language_text['_hpicon_forum'] = '<a href="{$hp}" target="_blank"><img src="../inc/lang/images/de/hp.png" alt="" title="{$hp}" class="icon" /></a>';
$language_text['_emailicon_forum'] = '<a href=\\"mailto:"+d+"\\"><img src=\\"../inc/lang/images/de/email.png\\" title="+d+" class=\\"icon\\" /></a>';
...
$language_text['_dl_add_new'] = '<a href="?admin=dl&amp;do=new">Neue Kategorie hinzufügen</a>';
$language_text['_dl_new_head'] = 'Neue Downloadkategorie hinzufügen';
$language_text['_dl_dlkat'] = 'Kategorie';
$language_text['_dl_empty_kat'] = 'Du musst eine Kategoriebezeichnung angeben!';
$language_text['_dl_admin_added'] = 'Die Downloadkategorie wurde erfolgreich hinzugefügt!';
$language_text['_dl_admin_deleted'] = 'Die Downloadkategorie wurde erfolgreich gelöscht!';
...
$language_text['_nothing'] = '<option value="lazy" class="dropdownKat">- nichts ändern -</option>';
