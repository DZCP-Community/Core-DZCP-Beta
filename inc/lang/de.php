...
define("_forum_online_info0", 'Es {if $total_users == 1}{lang msgID="forum_ist"}{else}{lang msgID="forum_sind"}{/if}<b> {$users}</b> Besucher online: <b>{$regs} </b>{if $counter_users == 1}{lang msgID="forum_reg"}{else}{lang msgID="forum_regs"}{/if} und <b>{$gast} </b>{if $total_users == 1}{lang msgID="forum_gast"}{else}{lang msgID="forum_gaste"}{/if} (Basierend auf den Besuchern der letzten {$timer} Minuten)');
