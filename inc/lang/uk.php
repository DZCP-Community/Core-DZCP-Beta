...
define('_profil_locked', 'Your account isn`t activated, <a href="?index=user&amp;action=akl&do=send" target="_self">&lt; get activation mail &gt;</a>');
define('_profil_closed', 'Your account is barred.');
define('_admin_akl_regist_subj', 'Subject: account activation mail');
define('_admin_akl_regist', 'account activation mail template');
define('_reg_akl_invalid', 'This link for account activation is exhausted!');
define('_reg_akl_valid', 'Your account has been activated!');
define('_reg_akl_sended', 'Your activation-code sent to "{$email}", check your inbox');
define('_reg_akl_email_nf', 'An account with this email doesn`t exist!');
define('_reg_akl_locked', 'This account ist permanently banned!');
define('_reg_akl_activated', 'Your Account is already activated');
define('_lostpwd_valid_sended', 'An activation-code for your account sent to your email, check your inbox!');
define('_info_reg_valid_akl', 'Registration complete!<br /><br /> Bitte aktiviere deinen Account &uuml;ber die Aktivierungs-eMail, die wir dir an deine E-Mail Adresse gesendet haben.<br /><br />Deine Zugangsdaten wurden dir an deine E-Mail Adresse "{$email}" versandt.');
...
define('_admin_akl_activated', 'Activations');
define('_actived', 'User account activated!');
define('_button_title_akl', 'Activate account');
